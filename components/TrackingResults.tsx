      ...
      <div className="status-card">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <p className="font-semibold text-gray-900">{shipment.origin}, {shipment.origincountry}</p>
          </div>
          <div>
            <p className="text-sm text-gray-500">Destination</p>
            <p className="font-semibold text-gray-900">{shipment.destination}, {shipment.destinationcountry}</p>
          </div>
        </div>
      </div>
